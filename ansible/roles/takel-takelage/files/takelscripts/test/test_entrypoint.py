...
def test_takelscripts_entrypoint_add_gopass_config_macos(
    ...
    config = \
        ...
        root:
          ...
          nopager: false
          notifications: true
          path: gpgcli-gitcli-fs+file://""" + str(tmp_path) + """/home/testuser/.password-store
          recipient_hash:
            .gpg-id: 1234567890
          safecontent: false
          usesymbols: false
        mounts:
          my-passwords:
            ...
            nopager: false
            notifications: true
            path: gpgcli-gitcli-fs+file://""" + str(tmp_path) + """/home/testuser/Library/Application%20Support/gopass/stores/.password-store-my-passwords
            recipient_hash:
              .gpg-id: 5678901234
            safecontent: false
            usesymbols: false
    ...
    config = \
        ...
        mounts:
          my-passwords:
            ...
            nopager: false
            notifications: true
            path: gpgcli-gitcli-fs+file://""" + str(tmp_path) + """/home/testuser/.password-store-my-passwords
            recipient_hash:
              .gpg-id: 5678901234
            safecontent: false
            usesymbols: false
