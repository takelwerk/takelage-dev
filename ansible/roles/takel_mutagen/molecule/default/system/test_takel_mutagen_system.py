...
def test_takel_mutagen_system_mutagen_version(host, testvars):
    takel_mutagen_mutagen_version = str(testvars['takel_mutagen_mutagen_version'])
    ...
    if takel_mutagen_mutagen_version == 'latest':
        response = requests.get("https://api.github.com/repos/mutagen-io/mutagen/releases/latest")
